...
//    添加歌曲
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile){
        ...
        String filePath = Constants.RESOURCE_MAC_PATH + System.getProperty("file.separator") + "song";
...
//    更新歌曲图片
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile urlFile, @RequestParam("id")int id){
        ...
        String filePath = Constants.RESOURCE_MAC_PATH + System.getProperty("file.separator") + "img" + System.getProperty("file.separator") + "songPic";
        File file1 = new File(filePath);
        if (!file1.exists()){
            file1.mkdir();
        }
