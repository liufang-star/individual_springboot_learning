...
public class QRCodeMusicUtil {
    ...
    private static final int CODE_HEIGHT = 550;
...
//                fileName = new Date().getTime() + ".png";
    ...
    private static BufferedImage getBufferedImage(String codeContent) throws WriterException, WriterException {
        /*
