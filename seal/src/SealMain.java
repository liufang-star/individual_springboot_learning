import cn.seal.SealUtil;
import cn.seal.configuration.SealCircle;
import cn.seal.configuration.SealConfiguration;
import cn.seal.configuration.SealFont;
...
//        centerFont.setFontSize(25);
        ...
        //1.生成公章
        try {
            SealUtil.buildAndStoreSeal(configuration, "G:\\myself_project_springboot\\individual_springboot_learning\\seal\\src\\cn\\img\\sealImg\\公章.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "G:\\myself_project_springboot\\individual_springboot_learning\\seal\\src\\cn\\img\\sealImg\\私章.png");
    }
}
